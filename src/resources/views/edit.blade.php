    ...
    >
        ...
        <x-admin.atoms.row>
            ...
            <input
                ...
                data-uic-original="/storage/{{ $collection->getMedia('laravel_block2_banner_original')->first()->id }}/{{ $collection->getMedia('laravel_block2_banner_original')->first()->file_name }}"
